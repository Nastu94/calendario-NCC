            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4 flex justify-end">
                        <a href="{{ route('veicoli.create') }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-6 rounded inline-flex items-center">
                            <x-heroicon-s-plus-circle />
                            <span class='space-from-element'>{{ __('Aggiungi Nuovo Veicolo') }}</span>
                        </a>
                    </div>
                                            ...
                                            @foreach ($veicoli as $veicolo)
                                                <tr>
                                                    ...
                                                    <td class="flex justify-center px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <a href="{{ route('veicoli.edit', $veicolo->id) }}" class="p-1 text-indigo-600 hover:text-indigo-900"><x-fas-edit  class="h-6 w-5 mb-2" /></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
